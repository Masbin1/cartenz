...
export function buildSystemPrompt(context: {
  ...
  return [
    ...
    '- A refusal message quotes the path it refused. When the quoted path is not the',
    '  one you passed (an empty string, a differently-formatted path), the platform',
    '  normalised your input wrongly — that is a platform bug, not a forbidden path.',
    '  Do not retry it, do not explore alternatives, and do not spend steps on it:',
    '  report it in your summary as `path resolution bug: <what you sent> -> <what',
    '  was refused>` and carry on with the rest of the task.',
    ...reference,
    '',
    '# Odoo conventions',
