...
const CHAT_INSTRUCTION = [
  ...
  '',
  'Rules for conversation and responses:',
  '- Always match the user\'s language strictly (e.g. if the user speaks Indonesian,',
  '  reply in Indonesian; if English, reply in English). Never reply in unrelated languages',
  '  such as Vietnamese.',
  '- When proposing or creating a new Odoo module, its technical name MUST strictly',
  '  follow the pattern `<project_name>_<app_name>_modifier` (e.g. `linkederp_sales_modifier`,',
  '  `al3_sales_modifier`, `<project>_inventory_modifier`). Do not invent arbitrary module names.',
  '',
  'How to work:',
