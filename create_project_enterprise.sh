...
# ============================================================
# Odoo 19 - Generic Multi-Project Enterprise Creator
# ============================================================
#
# Usage:
#   create_project_enterprise <project_name> <http_port>
#
# Example:
#   create_project_enterprise pipamas 9091
#
# Result:
...
usage() {
    echo
    echo "Usage:"
    echo "  create_project_enterprise <project_name> <http_port>"
    echo
    echo "Example:"
    echo "  create_project_enterprise pipamas 9091"
    echo
    exit 1
}
...
addons_path = ${ODOO_DIR}/addons,/opt/odoo/enterprise,${ADDONS_DIR}
